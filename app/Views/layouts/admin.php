...
<body>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
        <div class="page-header row">
            <div class="header-logo-wrapper col-auto">
                <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light"
                            src="<?= base_url() ?>admin/assets/images/logo/logo.png" alt="" /><img
                            class="img-fluid for-dark" src="<?= base_url() ?>admin/assets/images/logo/logo_light.png"
                            alt="" /></a></div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="header-logo-wrapper col-auto p-0">
                        <div class="logo-wrapper"><a href="index.html"><img class="img-fluid"
                                    src="<?= base_url() ?>admin/assets/images/logo/logo.png" alt=""></a></div>
                    ...
                    <div class="nav-right col-xxl-8 col-xl-6 col-md-7 col-8 pull-right right-header p-0 ms-auto">
                        <ul class="nav-menus">
                            <li> <span class="header-search">
                                    <svg>
                                        <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#search"></use>
                                    </svg></span></li>
                            <li>
                                <div class="form-group w-100">
                                    <div class="Typeahead Typeahead--twitterUsers">
                                        <div class="u-posRelative d-flex align-items-center">
                                            <svg class="search-bg svg-color">
                                                <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#search">
                                                </use>
                                            </svg>
                            ...
                            <li class="onhover-dropdown">
                                <div class="notification-box">
                                    <svg>
                                        <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#notification">
                                        </use>
                                    ...
                                    <ul class="notification-box">
                                        <li class="d-flex">
                                            <div class="flex-shrink-0 bg-light-primary"><img
                                                    src="<?= base_url() ?>admin/assets/images/dashboard/icon/wallet.png"
                                                    alt="Wallet"></div>
                                        ...
                                        <li class="d-flex">
                                            <div class="flex-shrink-0 bg-light-warning"><img
                                                    src="<?= base_url() ?>admin/assets/images/dashboard/icon/graph.png"
                                                    alt="Graph"></div>
                                            <div class="flex-grow-1"> <a href="private-chat.html">
                            ...
                            <li class="onhover-dropdown">
                                <svg>
                                    <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#header-bookmark"></use>
                                </svg>
                            ...
                            <li class="onhover-dropdown">
                                <div class="notification-box">
                                    <svg>
                                        <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#header-message">
                                        </use>
                            ...
                            <li class="cart-nav onhover-dropdown">
                                <div class="cart-box">
                                    <svg>
                                        <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-ecommerce">
                                        </use>
                                    </svg>
                                </div>
                                    ...
                                    <ul>
                                        <li>
                                            <div class="d-flex"><img class="img-fluid b-r-5 me-3 img-60"
                                                    src="<?= base_url() ?>admin/assets/images/other-images/cart-img.jpg"
                                                    alt="">
                                        ...
                                        <li>
                                            <div class="d-flex"><img class="img-fluid b-r-5 me-3 img-60"
                                                    src="<?= base_url() ?>admin/assets/images/other-images/table-img.jpg"
                                                    alt="">
                                        ...
                                        <li class="total">
                                            <h6 class="mb-0">Order Total : <span class="f-w-600 f-right">$1000.00</span>
                                            </h6>
                                        </li>
        ...
        <div class="page-body-wrapper">
            ...
            <div class="sidebar-wrapper" data-layout="stroke-svg">
                <div>
                    <div class="logo-wrapper"><a href="index.html"><img class="img-fluid"
                                src="<?= base_url() ?>admin/assets/images/logo/logo_light.png" alt=""></a>
                    ...
                    <div class="logo-icon-wrapper"><a href="index.html"><img class="img-fluid"
                                src="<?= base_url() ?>admin/assets/images/logo/logo-icon.png" alt=""></a></div>
                    <nav class="sidebar-main">
                        <div class="left-arrow" id="left-arrow"><i data-feather="arrow-left"></i></div>
                        <div id="sidebar-menu">
                            <ul class="sidebar-links" id="simple-bar">
                                <li class="back-btn"><a href="index.html"><img class="img-fluid"
                                            src="<?= base_url() ?>admin/assets/images/logo/logo-icon.png" alt=""></a>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        class="sidebar-link sidebar-title" href="javascript:void(0)">
                                        <svg class="stroke-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-widget">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-widget">
                                            </use>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        class="sidebar-link sidebar-title" href="javascript:void(0)">
                                        <svg class="stroke-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-layout">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-layout">
                                            </use>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"> </i><a
                                        ...
                                        <svg class="stroke-icon">
                                            <use
                                                href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-project">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-project">
                                            </use>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        ...
                                        <svg class="stroke-icon">
                                            <use
                                                href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-ecommerce">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use
                                                href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-ecommerce">
                                            </use>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        ...
                                        <svg class="stroke-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-email">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-email">
                                            </use>
                                        </svg><span>Letter Box</span></a></li>
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        class="sidebar-link sidebar-title" href="javascript:void(0)">
                                        <svg class="stroke-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-chat">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-chat">
                                            </use>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        class="sidebar-link sidebar-title" href="javascript:void(0)">
                                        <svg class="stroke-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-user">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-user">
                                            </use>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        ...
                                        <svg class="stroke-icon">
                                            <use
                                                href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-bookmark">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-bookmark">
                                            </use>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        ...
                                        <svg class="stroke-icon">
                                            <use
                                                href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-contact">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-contact">
                                            </use>
                                        </svg><span>Contacts</span></a></li>
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        class="sidebar-link sidebar-title link-nav" href="task.html">
                                        <svg class="stroke-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-task">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-task">
                                            </use>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        ...
                                        <svg class="stroke-icon">
                                            <use
                                                href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-calendar">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-calender">
                                            </use>
                                        </svg><span>Calendar</span></a></li>
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        class="sidebar-link sidebar-title link-nav" href="social-app.html">
                                        <svg class="stroke-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-social">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-social">
                                            </use>
                                        </svg><span>Social App</span></a></li>
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        class="sidebar-link sidebar-title link-nav" href="to-do.html">
                                        <svg class="stroke-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-to-do">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-to-do">
                                            </use>
                                        </svg><span>To-Do</span></a></li>
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        class="sidebar-link sidebar-title link-nav" href="search.html">
                                        <svg class="stroke-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-search">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-search">
                                            </use>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        class="sidebar-link sidebar-title" href="javascript:void(0)">
                                        <svg class="stroke-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-form">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-form">
                                            </use>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        class="sidebar-link sidebar-title" href="javascript:void(0)">
                                        <svg class="stroke-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-table">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-table">
                                            </use>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        ...
                                        <svg class="stroke-icon">
                                            <use
                                                href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-ui-kits">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-ui-kits">
                                            </use>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        ...
                                        <svg class="stroke-icon">
                                            <use
                                                href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-bonus-kit">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use
                                                href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-bonus-kit">
                                            </use>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        ...
                                        <svg class="stroke-icon">
                                            <use
                                                href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-animation">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use
                                                href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-animation">
                                            </use>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        class="sidebar-link sidebar-title" href="javascript:void(0)">
                                        <svg class="stroke-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-icons">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-icons">
                                            </use>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        class="sidebar-link sidebar-title" href="javascript:void(0)">
                                        <svg class="stroke-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-button">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-button">
                                            </use>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        class="sidebar-link sidebar-title" href="javascript:void(0)">
                                        <svg class="stroke-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-charts">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-charts">
                                            </use>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        ...
                                        <svg class="stroke-icon">
                                            <use
                                                href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-landing-page">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use
                                                href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-landing-page">
                                            </use>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        ...
                                        <svg class="stroke-icon">
                                            <use
                                                href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-sample-page">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use
                                                href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-sample-page">
                                            </use>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        ...
                                        <svg class="stroke-icon">
                                            <use
                                                href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-internationalization">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use
                                                href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-internationalization">
                                            </use>
                                        </svg><span>Internationalization</span></a></li>
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        class="sidebar-link sidebar-title link-nav"
                                        href="<?= base_url() ?>admin/starter-kit/index.html" target="_blank">
                                        <svg class="stroke-icon">
                                            <use
                                                href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-starter-kit">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use
                                                href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-starter-kit">
                                            </use>
                                        </svg><span>Starter kit</span></a></li>
                                <li class="mega-menu sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        class="sidebar-link sidebar-title" href="javascript:void(0)">
                                        <svg class="stroke-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-others">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-others">
                                            </use>
                                                    ...
                                                    <div class="link-section">
                                                        ...
                                                        <ul class="submenu-content opensubmegamenu">
                                                            ...
                                                            <li><a href="sign-up.html" target="_blank">Register
                                                                    Simple</a></li>
                                                            <li><a href="sign-up-one.html" target="_blank">Register with
                                                                    Bg Image </a></li>
                                                            <li><a href="sign-up-two.html" target="_blank">Register with
                                                                    image two</a></li>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        ...
                                        <svg class="stroke-icon">
                                            <use
                                                href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-gallery">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-gallery">
                                            </use>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        class="sidebar-link sidebar-title" href="javascript:void(0)">
                                        <svg class="stroke-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-blog">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-blog">
                                            </use>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        ...
                                        <svg class="stroke-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-faq">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-faq">
                                            </use>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        ...
                                        <svg class="stroke-icon">
                                            <use
                                                href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-job-search">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use
                                                href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-job-search">
                                            </use>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        ...
                                        <svg class="stroke-icon">
                                            <use
                                                href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-learning">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-learning">
                                            </use>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        class="sidebar-link sidebar-title" href="javascript:void(0)">
                                        <svg class="stroke-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-maps">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-maps">
                                            </use>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        ...
                                        <svg class="stroke-icon">
                                            <use
                                                href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-editors">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-editors">
                                            </use>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        ...
                                        <svg class="stroke-icon">
                                            <use
                                                href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-knowledgebase">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use
                                                href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-knowledgebase">
                                            </use>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        ...
                                        <svg class="stroke-icon">
                                            <use
                                                href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#stroke-support-tickets">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use
                                                href="<?= base_url() ?>admin/assets/svg/icon-sprite.svg#fill-support-tickets">
                                            </use>
                                    ...
                                    <div class="header-top">
                                        ...
                                        <div class="dropdown icon-dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end"
                                                aria-labelledby="userdropdown17"><a class="dropdown-item"
                                            ...
                                            <div class="location-menu dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end"
                                                    aria-labelledby="userdropdown"><a class="dropdown-item"
                                                        href="#">Address Selection</a><a class="dropdown-item"
                                            ...
                                            <div class="dropdown icon-dropdown">
                                                <button class="btn dropdown-toggle" id="userdropdown16" type="button"
                                                    data-bs-toggle="dropdown" aria-expanded="false"><i
                                                        class="icon-more-alt"></i></button>
                                                <div class="dropdown-menu dropdown-menu-end"
                                                    aria-labelledby="userdropdown16"><a class="dropdown-item"
                                        ...
                                        <div class="dropdown icon-dropdown">
                                            <button class="btn dropdown-toggle" id="userdropdown0" type="button"
                                                data-bs-toggle="dropdown" aria-expanded="false"><i
                                                    class="icon-more-alt"></i></button>
                                            <div class="dropdown-menu dropdown-menu-end"
                                                aria-labelledby="userdropdown0"><a class="dropdown-item"
                                                    href="#">Weekly</a><a class="dropdown-item" href="#">Monthly</a><a
                                                    class="dropdown-item" href="#">Yearly</a></div>
                                        </div>
                                    </div>
                                                        ...
                                                        <div class="dropdown icon-dropdown">
                                                            <button class="btn dropdown-toggle" id="userdropdown10"
                                                                ...
                                                                aria-expanded="false"><i
                                                                    class="icon-more-alt"></i></button>
                                                            <div class="dropdown-menu dropdown-menu-end"
                                                                aria-labelledby="userdropdown10"><a
                                        ...
                                        <div class="dropdown icon-dropdown">
                                            <button class="btn dropdown-toggle" id="userdropdown11" type="button"
                                                data-bs-toggle="dropdown" aria-expanded="false"><i
                                                    class="icon-more-alt"></i></button>
                                            <div class="dropdown-menu dropdown-menu-end"
                                                aria-labelledby="userdropdown11"><a class="dropdown-item"
                                                    href="#">Weekly</a><a class="dropdown-item" href="#">Monthly</a><a
                                                    class="dropdown-item" href="#">Yearly</a></div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="dropdown icon-dropdown">
                                            <button class="btn dropdown-toggle" id="userdropdown12" type="button"
                                                data-bs-toggle="dropdown" aria-expanded="false"><i
                                                    class="icon-more-alt"></i></button>
                                            <div class="dropdown-menu dropdown-menu-end"
                                                aria-labelledby="userdropdown12"><a class="dropdown-item"
                                                    href="#">Weekly</a><a class="dropdown-item" href="#">Monthly</a><a
                                                    class="dropdown-item" href="#">Yearly</a></div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-5">
                                            <ul class="appointments-user">
                                                <li class="d-flex align-items-center">
                                                    <div class="flex-shrink-0"><img
                                                            src="<?= base_url() ?>admin/assets/images/dashboard/user/05.png"
                                                            alt=""></div>
                                                    <div class="flex-grow-1"><a href="private-chat.html">
                                                            <h5>John Elliot</h5>
                                                        </a>
                                                ...
                                                <li class="d-flex align-items-center">
                                                    <div class="flex-shrink-0"><img
                                                            src="<?= base_url() ?>admin/assets/images/dashboard/user/06.png"
                                                            alt=""></div>
                                                    <div class="flex-grow-1"><a href="private-chat.html">
                                                            <h5>Ashley Hart</h5>
                                                        </a>
                                                ...
                                                <li class="d-flex align-items-center">
                                                    <div class="flex-shrink-0"><img
                                                            src="<?= base_url() ?>admin/assets/images/dashboard/user/07.png"
                                                            alt=""></div>
                                                    <div class="flex-grow-1"><a href="private-chat.html">
                                                            <h5>Anna lverson</h5>
                                                        </a>
                                                ...
                                                <li class="d-flex align-items-center">
                                                    <div class="flex-shrink-0"><img
                                                            src="<?= base_url() ?>admin/assets/images/dashboard/user/08.png"
                                                            alt=""></div>
                                                    <div class="flex-grow-1"><a href="private-chat.html">
                                                            <h5>Dana Lemon</h5>
                                                        </a>
                                        ...
                                        <div class="dropdown icon-dropdown">
                                            <button class="btn dropdown-toggle" id="userdropdown13" type="button"
                                                data-bs-toggle="dropdown" aria-expanded="false"><i
                                                    class="icon-more-alt"></i></button>
                                            <div class="dropdown-menu dropdown-menu-end"
                                                aria-labelledby="userdropdown13"><a class="dropdown-item"
                                                    href="#">Weekly</a><a class="dropdown-item" href="#">Monthly</a><a
                                                    class="dropdown-item" href="#">Yearly</a></div>
                                        </div>
                                    </div>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0"><img
                                                                    src="<?= base_url() ?>admin/assets/images/dashboard/user/01.jpg"
                                                                    alt=""></div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0"><img
                                                                    src="<?= base_url() ?>admin/assets/images/dashboard/user/02.jpg"
                                                                    alt=""></div>
                                                            <div class="flex-grow-1"><a href="product.html">
                                                                    <h5>Ashley Hart</h5>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0"><img
                                                                    src="<?= base_url() ?>admin/assets/images/dashboard/user/03.jpg"
                                                                    alt=""></div>
                                                            <div class="flex-grow-1"><a href="product.html">
                                                                    <h5>Anna lverson </h5>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0"><img
                                                                    src="<?= base_url() ?>admin/assets/images/dashboard/user/04.jpg"
                                                                    alt=""></div>
                                                            <div class="flex-grow-1"><a href="product.html">
                                                                    <h5>Ron Dayley</h5>
                                ...
                                <div class="card-body sale-statistic">
                                    <div class="row">
                                        <div class="col-3 statistic-icon">
                                            <div class="light-card balance-card widget-hover">
                                                <div class="icon-box"><img
                                                        src="<?= base_url() ?>admin/assets/images/dashboard/icon/customers.png"
                                                        alt=""></div>
                                        ...
                                        <div class="col-3 statistic-icon">
                                            <div class="light-card balance-card widget-hover">
                                                <div class="icon-box"><img
                                                        src="<?= base_url() ?>admin/assets/images/dashboard/icon/revenue.png"
                                                        alt=""></div>
                                        ...
                                        <div class="col-3 statistic-icon">
                                            <div class="light-card balance-card widget-hover">
                                                <div class="icon-box"><img
                                                        src="<?= base_url() ?>admin/assets/images/dashboard/icon/profit.png"
                                                        alt=""></div>
                                        ...
                                        <div class="dropdown icon-dropdown">
                                            <button class="btn dropdown-toggle" id="userdropdown15" type="button"
                                                data-bs-toggle="dropdown" aria-expanded="false"><i
                                                    class="icon-more-alt"></i></button>
                                            <div class="dropdown-menu dropdown-menu-end"
                                                aria-labelledby="userdropdown15"><a class="dropdown-item"
                                                    href="#">Weekly</a><a class="dropdown-item" href="#">Monthly</a><a
                                                    class="dropdown-item" href="#">Yearly</a></div>
                                        </div>
                                    </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="progress progress-striped-warning b-r-2">
                                                            <div class="progress-bar" role="progressbar"
                                                                style="width: 60%" aria-valuenow="10" aria-valuemin="0"
                                                                aria-valuemax="100"></div>
                                                        </div>
                                                    </td>
                                                </tr>
    ...
    <!-- calendar js-->
    <script src="<?= base_url() ?>admin/assets/js/dashboard/default.js"></script>
