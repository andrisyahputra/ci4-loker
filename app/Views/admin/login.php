    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-7 order-1"><img class="bg-img-cover bg-center"
                    src="<?= base_url() ?>admin/assets/images/login/1.jpg" alt="looginpage"></div>
            <div class="col-xl-5 p-0">
                <div class="login-card login-dark">
                    <div>
                        <div><a class="logo text-start" href="index.html"><img class="img-fluid for-light"
                                    src="<?= base_url() ?>admin/assets/images/logo/logo.png" alt="looginpage"><img
                                    class="img-fluid for-dark"
                                    src="<?= base_url() ?>admin/assets/images/logo/logo_dark.png" alt="looginpage"></a>
                        </div>
                        <div class="login-main">
                            <?php if (session()->getFlashdata('success')): ?>
                                <div class="alert alert-light-success" role="alert">
                                    <div class="txt-success"><strong>Berhasil</strong>
                            ...
                            <?php endif ?>
                            <form class="theme-form" method="POST" action="<?= url_to('admin.cek.login') ?>">
